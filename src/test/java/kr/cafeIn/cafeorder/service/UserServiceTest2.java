...
@Transactional
 class UserServiceTest2 {
    ...
    public void WithdrawnLessThan3DaysAgo()  {
        ...
        RegistrationException e = Assert.assertThrows(RegistrationException.class, () -> userService.register(Optional.ofNullable(user)));
   ...
   @DisplayName("회원탈퇴:성공")
    ...
    public void testWithdraw_MemberNotFound()  {
       ...
       WithdrawalException e = Assert.assertThrows(WithdrawalException.class, () -> userService.withdraw(id));
